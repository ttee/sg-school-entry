...
import DualValidationMapSmathWeek87 from "./DualValidationMapSmathWeek87";
import DualValidationMapSmathWeek88 from "./DualValidationMapSmathWeek88";
...
import DualValidationMapSmathWeek93 from "./DualValidationMapSmathWeek93";
import DualValidationMapSmathWeek94 from "./DualValidationMapSmathWeek94";
import DualValidationMapSmathWeek95 from "./DualValidationMapSmathWeek95";
import DualValidationMapSmathWeek96 from "./DualValidationMapSmathWeek96";
import DualValidationMapSmathWeek97 from "./DualValidationMapSmathWeek97";
import DualValidationMapSmathWeek98 from "./DualValidationMapSmathWeek98";
import DualValidationMapSmathWeek99 from "./DualValidationMapSmathWeek99";
import DualValidationMapSmathWeek100 from "./DualValidationMapSmathWeek100";
import DualValidationMapSmathWeek101 from "./DualValidationMapSmathWeek101";
import DualValidationMapSmathWeek102 from "./DualValidationMapSmathWeek102";
import DualValidationMapSmathWeek103 from "./DualValidationMapSmathWeek103";
import DualValidationMapSmathWeek104 from "./DualValidationMapSmathWeek104";
import DualValidationMapSmathWeek105 from "./DualValidationMapSmathWeek105";
import DualValidationMapSmathWeek106 from "./DualValidationMapSmathWeek106";
...
export default function WeekHomework({
  ...
  return (
    <div>
      ...
      {week.level === "SMATH" && week.weekNumber === 86 && <DualValidationMapSmathWeek86 />}
      {week.level === "SMATH" && week.weekNumber === 87 && <DualValidationMapSmathWeek87 />}
      {week.level === "SMATH" && week.weekNumber === 88 && <DualValidationMapSmathWeek88 />}
      ...
      {week.level === "SMATH" && week.weekNumber === 93 && <DualValidationMapSmathWeek93 />}
      {week.level === "SMATH" && week.weekNumber === 94 && <DualValidationMapSmathWeek94 />}
      {week.level === "SMATH" && week.weekNumber === 95 && <DualValidationMapSmathWeek95 />}
      {week.level === "SMATH" && week.weekNumber === 96 && <DualValidationMapSmathWeek96 />}
      {week.level === "SMATH" && week.weekNumber === 97 && <DualValidationMapSmathWeek97 />}
      {week.level === "SMATH" && week.weekNumber === 98 && <DualValidationMapSmathWeek98 />}
      {week.level === "SMATH" && week.weekNumber === 99 && <DualValidationMapSmathWeek99 />}
      {week.level === "SMATH" && week.weekNumber === 100 && <DualValidationMapSmathWeek100 />}
      {week.level === "SMATH" && week.weekNumber === 101 && <DualValidationMapSmathWeek101 />}
      {week.level === "SMATH" && week.weekNumber === 102 && <DualValidationMapSmathWeek102 />}
      {week.level === "SMATH" && week.weekNumber === 103 && <DualValidationMapSmathWeek103 />}
      {week.level === "SMATH" && week.weekNumber === 104 && <DualValidationMapSmathWeek104 />}
      {week.level === "SMATH" && week.weekNumber === 105 && <DualValidationMapSmathWeek105 />}
      {week.level === "SMATH" && week.weekNumber === 106 && <DualValidationMapSmathWeek106 />}
