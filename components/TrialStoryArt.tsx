...
const PAIRS: Record<StoryKey, Pair> = {
  "A2-0": {
    story: {
      ...
      video: "/trial/a2-w0-setup.mp4?v=mouthfill1",
      titleZh: "第 1 段 · 走廊（还没到 Lost & Found）",
      captionZh: "Mei 坐在地上倒书包。Priya 来帮她。",
      captionEn: "Mei: Oh no! Where is my water bottle? I cannot find it.  Priya: Let's go to the Lost and Found. Aunty Tan can help.",
    },
    form: {
      poster: "/trial/a2-w0-counter.jpg",
      video: "/trial/a2-w0-counter.mp4?v=mouthfill1",
      titleZh: "第 2 段 · Lost & Found 柜台",
      captionZh: "Aunty Tan 拿出水瓶。Mei 道谢。",
      captionEn: "Aunty Tan: Is this your white bottle with the pink flower?  Mei: Yes! That is mine. Thank you so much, Aunty Tan.",
    },
  },
  "A2-1": {
    story: {
