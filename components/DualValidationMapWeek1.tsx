export default function DualValidationMapWeek1() {
  return (
      ...
      <div className="overflow-x-auto">
        <table className="w-full border border-accent/20 rounded-lg overflow-hidden text-sm bg-card">
          ...
          <tbody>
            ...
            <tr className="border-b border-accent/10">
              <td className="px-3 py-3 text-ink align-top">
                <strong>语法</strong><br />完形：she wakes / at 7:00 / in the morning
              </td>
              <td className="px-3 py-3 text-ink-2 align-top">
                <strong>Reading Part 4</strong><br />语法选择填空
              </td>
              <td className="px-3 py-3 text-ink-2 align-top">
                练第三人称单数动词 -s（wakes/goes/has）和时间介词 at/in/on，短文完形选择题
              </td>
            </tr>
            <tr className="border-b border-accent/10">
              <td className="px-3 py-3 text-ink align-top">
                <strong>写作</strong><br />邮件 50–70 词，讲自己作息
              </td>
              <td className="px-3 py-3 text-ink-2 align-top">
                <strong>Part 6 guided email</strong><br />官方最低 25 词
              </td>
              <td className="px-3 py-3 text-ink-2 align-top">
                写邮件给朋友，讲起床时间、早餐、上学路线、晚上作息，练 50–70 词作为拉伸
              </td>
            </tr>
            <tr className="border-b border-accent/10">
              <td className="px-3 py-3 text-ink align-top">
            ...
            <tr>
              <td className="px-3 py-3 text-ink align-top">
                <strong>口语</strong><br />~1 分钟讲自己的上学早晨
              </td>
              <td className="px-3 py-3 text-ink-2 align-top">
