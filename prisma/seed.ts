      ...
      questions: [
        ...
        },
        {
          ...
          options: JSON.stringify([
            ...
            "Wei rearranges y + 1 = 4x into the form y = ax + b. What is the result?|A. y = 4x − 1|B. y = 4x + 1|C. y = x + 4|D. y = −1 + 4x is already in the correct form",
            "For the function y = 10x + 5, find y when x = 3.|A. 35|B. 30|C. 15|D. 25",
            "Aisha says: in the function y = 3x + 7, the coefficient of x is 7 and the constant term is 3. Is Aisha correct?|A. No, the coefficient of x is 3 and the constant term is 7|B. Yes, Aisha is correct|C. No, both are wrong|D. The function is not in the form y = ax + b",
          ]),
          correctAnswer: "A,A,A,A,A,A,A,A",
          points: 16,
        },
