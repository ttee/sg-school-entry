      ...
      questions: [
        ...
        },
        {
          ...
          options: JSON.stringify([
            ...
            "Mr Lim asks: is the point (0, 5) on the graph of y = 3x + 5?|A. Yes, when x = 0, y = 3(0) + 5 = 5 ✓|B. No, the y-intercept is 3 not 5|C. Yes, because the constant term is 5|D. No, the point should be (5, 0)",
            "The graph of y = 4x + 2 is a straight line. Wei says the point (1, 6) is on this line. Is Wei correct?|A. Yes, substitute x = 1: y = 4(1) + 2 = 6 ✓|B. No, the y-intercept is (0, 2) not (1, 6)|C. No, the coefficient is 4 not 6|D. Yes, because 4 + 2 = 6",
