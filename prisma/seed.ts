      ...
      questions: [
        {
          ...
          options: JSON.stringify([
            ...
            "Which expression matches the statement \"3 more than n\"?|A. 3n|B. n + 3|C. 3 + n|D. n × 3",
          ]),
        ...
        },
        {
          ...
          options: JSON.stringify([
            ...
            "Which working shows the correct expression for \"twice n\"?|A. n + 2|B. 2 × n|C. n × 2|D. Both B and C",
          ]),
          correctAnswer: "B,B,C,C,A,C,C,D",
          points: 16,
        },
        {
          type: "writing",
