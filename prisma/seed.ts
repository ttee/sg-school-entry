...
Choose the correct answer:`,
          options: JSON.stringify([
            ...
            "Who checked on Wei during the break?|A. Mr Lim|B. Aisha|C. Nurse Ong|D. His parents",
          ]),
          correctAnswer: "B,C,C,C,B",
          points: 10,
        },
        {
          ...
          options: JSON.stringify([
            ...
            "The nurse was busy, _____ she helped Wei immediately.|A. although|B. so|C. but|D. because",
            "_____ the sick bay was quiet, Wei felt more relaxed.|A. But|B. So|C. Although|D. Because",
            "Wei wanted to go back to class, _____ Nurse Ong told him to rest.|A. although|B. but|C. so|D. because",
            "_____ Mr Lim was teaching, he stopped to help Wei.|A. But|B. Although|C. So|D. Because",
            "The headache was still there, _____ it was not as bad.|A. although|B. because|C. but|D. so",
            "_____ Wei drank water, he felt a bit better.|A. Although|B. But|C. So|D. Because",
            "Aisha was worried, _____ she continued with her work.|A. although|B. but|C. so|D. because",
          ]),
