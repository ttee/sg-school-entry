          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              ...
              <article className="bg-card border border-line rounded-2xl p-6 shadow">
                ...
                <p className="text-sm text-ink-2 mb-2">试学周 + 第 1–24 周 · P2 + P3 + P4 十万以内整数 + 因数倍数 + 乘除算法 + 带分数假分数 + 一组的几分之几 + 分数加减 + P4 小数位值比较转换四舍五入 + P4 小数加减 + P4 小数乘除一位整数 + P4 面积周长求缺失边与组合图形 + P4 表格和折线图</p>
                <p className="text-xs text-muted">试学周免费</p>
              </article>
            </div>
          </div>
