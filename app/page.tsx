      ...
      <main id="main">
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="mb-8 bg-accent/5 border border-accent/20 rounded-xl p-6">
              ...
              <p className="text-sm text-ink-2 mb-4">
                小班直播课（每周 2 次，每次 1.5 小时）+ 每周作业 app 解锁当前级别已上线周数（A2 试学周 + 第 1–4 周，B1 试学周 + 第 1–3 周，后续周次陆续更新）。包含 CEQ 备考四项技能：阅读、写作、听读准备、口语提示。
              </p>
              <ul className="space-y-2 text-sm text-ink-2 mb-5">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-accent mt-0.5">✓</span>
                  <span>每周作业 app 解锁已上线周数（A2: 试学周 + 第 1–4 周；B1: 试学周 + 第 1–3 周；后续周次陆续更新）</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-accent mt-0.5">✓</span>
        ...
        <section className="py-12 md:py-16 bg-paper" id="pedagogy">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <h3 className="font-serif font-semibold text-xl mb-4 text-ink">已上线纠错地图（A2 共 5 周，B1 共 4 周）</h3>
