          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              ...
              <article className="bg-card border border-line rounded-2xl p-6 shadow">
                ...
                <p className="text-sm text-ink-2 mb-2">试学周 + 第 1–10 周 · P2 全套 + P3 整数/乘除/分数/测量/面积周长</p>
                <p className="text-xs text-muted">试学周免费</p>
              </article>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-5 mb-8">
              <article className="bg-card border border-line rounded-2xl p-6 shadow">
                ...
                <p className="text-ink-2 mb-4 text-sm">
                  作业 app 解锁已上线周数（A2 试学周 + 第 1–11 周，B1 试学周 + 第 1–11 周，MATH 试学周 + 第 1–10 周）+ 家长微信进度通报。可随时取消。
                </p>
