          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              ...
              <article className="bg-card border border-line rounded-2xl p-6 shadow">
                ...
                <p className="text-sm text-ink-2 mb-2">试学周 + 第 1–27 周 · P2 + P3 + P4 十万以内整数 + 因数倍数 + 乘除算法 + 带分数假分数 + 一组的几分之几 + 分数加减 + P4 小数位值比较转换四舍五入 + P4 小数加减 + P4 小数乘除一位整数 + P4 面积周长求缺失边与组合图形 + P4 表格和折线图 + P4 饼图 + P4 角 + P4 长方形正方形</p>
                <p className="text-xs text-muted">试学周免费</p>
              </article>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-5 mb-8">
              <article className="bg-card border border-line rounded-2xl p-6 shadow">
                ...
                <p className="text-ink-2 mb-4 text-sm">
                  作业 app 解锁已上线周数（A2 试学周 + 第 1–11 周，B1 试学周 + 第 1–11 周，MATH 试学周 + 第 1–27 周）+ 家长微信进度通报。可随时取消。
                </p>
