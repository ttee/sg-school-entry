    ...
    items: [
      ...
      },
      {
        ...
        whyWrong: [
          "第一次说到这件衣服，用 a。",
          "pink 以辅音开头，不用 an。",
          "还没指定是哪一件 polo，不用 the。",
          "shirt 是单数可数名词，前面要加冠词，不能空着。",
        ],
      },
      {
        ...
        correctIndex: 2,
        whyWrong: [
          "这不是第一次随便提到，已经认出来了，不用 a。",
          "white 以辅音开头，而且已经认出来了，不用 an。",
          "已经认出来的那个水壶，用 the。",
          "已经指着那个水壶，前面要加 the，不能空着。",
        ],
      },
      {
        ...
        correctIndex: 1,
        whyWrong: [
          "email 以元音开头，第一次说不用 a，要用 an。",
          "email 以元音开头，第一次说到这封邮件，用 an。",
          "还没指明是哪一封邮件，不用 the。",
          "email 是单数可数名词，前面要加冠词，不能空着。",
        ],
      },
      {
        ...
        correctIndex: 2,
        whyWrong: [
          "这是学校里大家都知道的那一处，不是随便一个办公室，不用 a。",
          "Lost 以辅音开头，而且是大家都知道的那一处，不用 an。",
          "学校里大家知道的失物招领处，用 the。",
          "说到大家都知道的那间办公室，前面要加 the，不能空着。",
        ],
      },
      {
