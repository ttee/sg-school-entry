...
Ah Gong asked, "Is there any soup?" "Yes. Some soup for you," said the Aunty. The tables were full. Priya asked another family, "Can we share a table?" They made space. After dinner they returned the trays. Ah Ma said, "Next time we can try nasi lemak."`,
  ...
  1: `It was Mei's first morning at a Singapore primary school. The field was already full. Ms Tan smiled at the class. "Good morning, class." Mei said, "Good morning, Ms Tan." Priya asked, "Where do we line up?" Mei said, "I am in Blue House." They stood with Blue House. After assembly they walked to the canteen for recess.`,
