...
export const PARENT_SNIPPET = [
  ...
  {
    title: "AEIS（国际学生入学考试）",
    body: "小学从 2022 年起英语改交 CEQ，AEIS 只考数学。中学仍考英语+数学（英语约 2 小时 10 分：作文 + 50 题理解/完形/词汇/语法）。英文是实用英语，内容对准申请年级的前一级。人在中国先在本站练，CEQ 在剑桥授权考点考，再用本站 12 周作业冲 AEIS。录取不等于准证或 PR，以 ICA 为准。",
  },
];
